...
#define WLDebugLogResponse(response, responseObject,request, error) [[WLLogger sharedLogger] logResponse:response responseObject:responseObject request:request error:error];
#endif
 ...
 */
#ifndef WLDebugLog
#define WLDebugLog(format, ...) [[WLLogger sharedLogger] debugLog:[NSString stringWithFormat:@"%s", __PRETTY_FUNCTION__] message: format, ##__VA_ARGS__];
#endif
...
/**
 * Enabled switch, default NO - default set by WLConfiguration debug property
 */

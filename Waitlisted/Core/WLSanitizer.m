...
NSString * WLPercentEscapedStringFromString(NSString *string) {
    static NSString * const kWLCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kWLCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kWLCharactersGeneralDelimitersToEncode stringByAppendingString:kWLCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[WLQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[WLObject class]]) {

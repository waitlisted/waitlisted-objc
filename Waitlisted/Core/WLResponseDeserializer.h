 ...
 */
extern NSString *const WLDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const WLTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const WLEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const WLUnknownResponseObjectErrorCode;

@protocol WLResponseDeserializer <NSObject>
...
@interface WLResponseDeserializer : NSObject <WLResponseDeserializer>

...
NSString *const WLDeserializationErrorDomainKey = @"WLDeserializationErrorDomainKey";

NSInteger const WLTypeMismatchErrorCode = 143553;

NSInteger const WLEmptyValueOccurredErrorCode = 143509;

NSInteger const WLUnknownResponseObjectErrorCode = 143528;


@interface WLResponseDeserializer ()
...
@implementation WLResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:WLDeserializationErrorDomainKey code:WLTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:WLDeserializationErrorDomainKey code:WLEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:WLDeserializationErrorDomainKey code:WLUnknownResponseObjectErrorCode userInfo:userInfo];
}
